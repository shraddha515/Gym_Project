...
@section('content')
    <style>
     ...
     <div class="container py-4 px-4">
       ...
       <!-- Filter Section -->
<form method="GET" action="{{ route('gym.report') }}" class="report-filter row g-2 mb-4 align-items-end" id="reportFilterForm">
    <div class="col-6 col-md-2">
        <label class="form-label small mb-1">From</label>
        <input type="date" name="from" value="{{ $from ?? '' }}" class="form-control form-control-sm auto-filter">
    </div>
    <div class="col-6 col-md-2">
        <label class="form-label small mb-1">To</label>
        <input type="date" name="to" value="{{ $to ?? '' }}" class="form-control form-control-sm auto-filter">
    </div>
