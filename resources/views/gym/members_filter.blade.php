...
.report-label {
    font-size: 0.85rem;
    font-weight: 600;
    color: #6b7280; /* muted gray for professional look */
    text-transform: uppercase;
    margin-bottom: 15px;
    letter-spacing: 0.5px;
}
...
/* Values / Numbers */
.report-value {
    font-size: 2.2rem; /* slightly bigger for emphasis */
    font-weight: 700;
...
.report-card::before {
    ...
    background: linear-gradient(135deg, #3b82f6, #a855f7, #facc15, #3b82f6);
...
/* Ensure text/content above glow */
.report-card > * {
    position: relative;
    z-index: 1;
}
